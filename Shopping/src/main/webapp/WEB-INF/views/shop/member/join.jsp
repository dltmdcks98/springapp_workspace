...
var validId=false;//유효성 여부를 판단하는 기준 변수
...
function checkId(){
	...
	$.ajax({
		...
		success:function(result,status,xhr){
			console.log(result);
			//if(result.code==1){validId=true;	}else{validId=false;}
			//위의 코드를 간략화 시킬 경우 삼항 연산자를 사용할 수 있다. 
...
function login(){
	location.herf="/shop/member/loginform";
