		...
		<div class="container">
					...
					<div class="product__details__pic">
						<div
							...
							<a class="pt active" href="#product-1"> <img
								src="/static/data/<%=product.getProduct_img()%>" alt="">
				...
				<div class="col-lg-6">
					<div class="product__details__text">
						...
						<div class="product__details__price">
							won
							<%=CurrencyFormatter.getCurrency(product.getDiscount())%><span>won
								<%=CurrencyFormatter.getCurrency(product.getPrice())%></span>
						</div>
						<p><%=product.getMemo()%></p>
						<div class="product__details__button">
							...
							<a href="javascript:addCart()" class="cart-btn"><span class="icon_bag_alt"></span>
								Add to cart</a>
							<ul>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product__item">
						<div class="product__item__pic set-bg"
							data-setbg="/static/shop/img/product/related/rp-1.jpg">
							<div class="label new">New</div>
							<ul class="product__hover">
								<li><a href="/static/shop/img/product/related/rp-1.jpg"
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product__item">
						<div class="product__item__pic set-bg"
							data-setbg="/static/shop/img/product/related/rp-2.jpg">
							<ul class="product__hover">
								<li><a href="/static/shop/img/product/related/rp-2.jpg"
									class="image-popup"><span class="arrow_expand"></span></a></li>
								<li><a href="#"><span class="icon_heart_alt"></span></a></li>
								<li><a href="#"><span class="icon_bag_alt"></span></a></li>
							</ul>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product__item">
						<div class="product__item__pic set-bg"
							data-setbg="/static/shop/img/product/related/rp-3.jpg">
							<div class="label stockout">out of stock</div>
							<ul class="product__hover">
								<li><a href="/static/shop/img/product/related/rp-3.jpg"
									class="image-popup"><span class="arrow_expand"></span></a></li>
								<li><a href="#"><span class="icon_heart_alt"></span></a></li>
								<li><a href="#"><span class="icon_bag_alt"></span></a></li>
							</ul>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product__item">
						<div class="product__item__pic set-bg"
							data-setbg="/static/shop/img/product/related/rp-4.jpg">
							<ul class="product__hover">
								<li><a href="/static/shop/img/product/related/rp-4.jpg"
									class="image-popup"><span class="arrow_expand"></span></a></li>
								<li><a href="#"><span class="icon_heart_alt"></span></a></li>
								<li><a href="#"><span class="icon_bag_alt"></span></a></li>
							</ul>
