                    ...
                    <div class="product__details__pic">
                        ...
                        <div class="product__details__slider__content">
                            <div class="product__details__pic__slider owl-carousel">
                                ...
                                <img data-hash="product-2" class="product__big__img" src="/static/data/<%=product.getProduct_img()%>" alt="">
                                <img data-hash="product-3" class="product__big__img" src="/static/data/<%=product.getProduct_img()%>" alt="">
                                <img data-hash="product-4" class="product__big__img" src="/static/data/<%=product.getProduct_img()%>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
